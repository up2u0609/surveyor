  ...
  module SurveyorControllerMethods
    ...
    def update
      ...
      ActiveRecord::Base.transaction do
        saved = @response_set.update_attributes(:responses_attributes => Surveyor::ResponseSet.reject_or_destroy_blanks(params[:r]))
      ...
      respond_to do |format|
        format.html do
          ...
          redirect_to surveyor.edit_my_survey_path( :anchor => anchor_from(params[:section]), :section => section_id_from(params[:section]) )
        end
        format.js do
